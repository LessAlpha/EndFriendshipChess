...
exports.Cmds = {
    ...
    CREATE_ROOM     : 2,// 创建房间
    JOIN_ROOM       : 3,// 加入房间
    START_GAME      : 4,// 开始游戏（仅限房主）
    DELETE_ROOM     : 5,// 删除房间（仅限房主）


    OPERATE_LUCKY_NEXT    : 55,// S广播C下一个操作位置 
    OPERATE_LUCKY_END     : 56,// C告知S操作结束，S广播此次操作点数 
    OPERATE_FLY          : 57,// C告知S选择哪只飞机走动(如果只有一个可走动的话则自动发送)，S再广播并告知相关特殊结果（如果有）
    RESULT_GAME           : 58,// 结束结算
